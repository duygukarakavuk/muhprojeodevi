...
<table cellspacing="20" cellpadding="20" class="font1">
<p><font face= "tahoma" size=6
    ...
    <td></td>
    <td></td>
    <td><input type="submit" value="Kitap Guncelle" /></td>
    </tr>
...
<?php 
        ...
        if($_POST){
            ...
            $guncelle        =    mysqli_query($baglan,"update bilgiler set basim_yili='$yil',yayin_evi='$yayin' where seri_no='$seri'");
